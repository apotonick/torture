module Torture
  module Snippet
    ...
    def self.extract(input, marker:, collapse:nil, unindent:false, filename: nil)
      ...
      code = prepend_filename(code, filename) if filename
    ...
    def self.prepend_filename(code, filename)
      "#\s#{filename}\n\n#{code}"
    end
  end
end
